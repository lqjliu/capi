...
public class BeanConfiguration {
	...
	private BeanConfiguration() {
		beanMap.put("RegisterCorporation", "com.carucrm.biz.register.CorporationRegisterBean");
		beanMap.put("RegisterCorporation.mgr", "com.carucrm.biz.register.RegisterMgrImpl");
		beanMap.put("RegisterCorporation.api", "registerCorporation");
		beanMap.put("RegisterCorporation.authentication", "false");		
		
		beanMap.put("CheckSymbolDuplicated", "java.lang.String");
		beanMap.put("CheckSymbolDuplicated.mgr", "com.carucrm.biz.register.RegisterMgrImpl");
		...
		beanMap.put("CheckContactMobileDuplicated.mgr", "com.carucrm.biz.register.RegisterMgrImpl");
		beanMap.put("CheckContactMobileDuplicated.api", "isContactMobileDuplicated");
		beanMap.put("CheckContactMobileDuplicated.authentication", "false");
		
		beanMap.put("CheckAccountNameDuplicated", "java.lang.String");
		beanMap.put("CheckAccountNameDuplicated.mgr", "com.carucrm.biz.register.RegisterMgrImpl");
		...
		beanMap.put("CheckAccountEmailDuplicated.mgr", "com.carucrm.biz.register.RegisterMgrImpl");
		beanMap.put("CheckAccountEmailDuplicated.api", "isAccountEmailDuplicated");
		...
		beanMap.put("CheckAccountContactMobileDuplicated.mgr", "com.carucrm.biz.register.RegisterMgrImpl");
		beanMap.put("CheckAccountContactMobileDuplicated.api", "isAccountContactMobileDuplicated");
		beanMap.put("CheckAccountContactMobileDuplicated.authentication", "false");		
	
		beanMap.put("LoginCorporation", "com.carucrm.biz.login.LoginBean");
		beanMap.put("LoginCorporation.mgr", "com.carucrm.biz.login.LoginMgrImpl");
		beanMap.put("LoginCorporation.api", "loginCorporation");
		beanMap.put("LoginCorporation.authentication", "false");
		
		beanMap.put("GetCorporationRegisteration.mgr", "com.carucrm.biz.register.RegisterMgrImpl");
		beanMap.put("GetCorporationRegisteration.api", "getCorporationRegisteration");
		beanMap.put("GetCorporationRegisteration.authentication", "true");	
		
		beanMap.put("UpdateCorporationRegisteration", "com.carucrm.biz.register.CorporationRegisterBean");
		beanMap.put("UpdateCorporationRegisteration.mgr", "com.carucrm.biz.register.RegisterMgrImpl");
		beanMap.put("UpdateCorporationRegisteration.api", "updateCorporationRegisteration");
		beanMap.put("UpdateCorporationRegisteration.authentication", "true");
		
		beanMap.put("ChangePassword", "com.carucrm.biz.account.ChangePasswordBean");
		beanMap.put("ChangePassword.mgr", "com.carucrm.biz.account.AccountMgrImpl");
		...
		beanMap.put("AddCustomer.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		...
		beanMap.put("CheckCustomerMobileDuplicated.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		...
		beanMap.put("EditCustomer.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		...
		beanMap.put("GetCustomer.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		...
		beanMap.put("DeleteCustomer.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		...
		beanMap.put("SuggestCustomer.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		beanMap.put("SuggestCustomer.api", "suggestCustomer");
		beanMap.put("SuggestCustomer.authentication", "true");
		
		beanMap.put("GetCertainCustomer",  "com.carucrm.biz.customer.CustomerIDBean");
		beanMap.put("GetCertainCustomer.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		beanMap.put("GetCertainCustomer.api", "getCertainCustomer");
		beanMap.put("GetCertainCustomer.authentication", "true");
		
		beanMap.put("GetLatestCustomer",  "com.carucrm.biz.customer.LatestCustomerInputBean");
		beanMap.put("GetLatestCustomer.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		beanMap.put("GetLatestCustomer.api", "getLatestCustomer");
		beanMap.put("GetLatestCustomer.authentication", "true");
		
		beanMap.put("SearchCustomer",  "com.carucrm.biz.customer.SearchCustomerInputBean");
		beanMap.put("SearchCustomer.mgr", "com.carucrm.biz.customer.CustomerMgrImpl");
		...
		beanMap.put("DeleteConsume.mgr", "com.carucrm.biz.consume.ConsumeMgrImpl");
		...
		beanMap.put("ListConsume",  "com.carucrm.biz.consume.ConsumeListConditionBean");
		...
		beanMap.put("CheckCarOwnerAccountEmailDuplicated.mgr", "com.carucrm.biz.carowner.AccountMgrImpl");
		beanMap.put("CheckCarOwnerAccountEmailDuplicated.api", "isCarOwnerAccountEmailDuplicated");
		beanMap.put("CheckCarOwnerAccountEmailDuplicated.authentication", "false");
		
		beanMap.put("CheckCarOwnerAccountNameDuplicated",  "java.lang.String");
		beanMap.put("CheckCarOwnerAccountNameDuplicated.mgr", "com.carucrm.biz.carowner.AccountMgrImpl");
		beanMap.put("CheckCarOwnerAccountNameDuplicated.api", "isCarOwnerAccountNameDuplicated");
		beanMap.put("CheckCarOwnerAccountNameDuplicated.authentication", "false");
		
		beanMap.put("RegisterCarOwnerAccount",  "com.carucrm.biz.carowner.AccountBean");
		beanMap.put("RegisterCarOwnerAccount.mgr", "com.carucrm.biz.carowner.AccountMgrImpl");
		...
		beanMap.put("SendVerifiedCode.mgr", "com.carucrm.biz.carowner.AccountMgrImpl");
		...
		beanMap.put("LoginAsCarOwner.mgr", "com.carucrm.biz.carowner.AccountMgrImpl");
		beanMap.put("LoginAsCarOwner.api", "loginAsCarOwner");
		beanMap.put("LoginAsCarOwner.authentication", "false");
	
		beanMap.put("GetCarOwnerAccountBean.mgr", "com.carucrm.biz.carowner.AccountMgrImpl");
		beanMap.put("GetCarOwnerAccountBean.api", "getCarOwnerAccountBean");
		beanMap.put("GetCarOwnerAccountBean.authentication", "true");
		
		beanMap.put("UpdateCarOwnerAccount",  "com.carucrm.biz.carowner.UpdateAccountBean");
		beanMap.put("UpdateCarOwnerAccount.mgr", "com.carucrm.biz.carowner.AccountMgrImpl");
		beanMap.put("UpdateCarOwnerAccount.api", "updateCarOwnerAccount");
		beanMap.put("UpdateCarOwnerAccount.authentication", "true");
		
		beanMap.put("ListCarOwnerConsume",  "com.carucrm.biz.carowner.ConsumeListConditionBean");
		beanMap.put("ListCarOwnerConsume.mgr", "com.carucrm.biz.carowner.ConsumeMgrImpl");
		beanMap.put("ListCarOwnerConsume.api", "listCarOwnerConsume");
		beanMap.put("ListCarOwnerConsume.authentication", "true");
		
		beanMap.put("GetCarOwnerConsume",  "com.carucrm.biz.carowner.ConsumeIDBean");
		beanMap.put("GetCarOwnerConsume.mgr", "com.carucrm.biz.carowner.ConsumeMgrImpl");
