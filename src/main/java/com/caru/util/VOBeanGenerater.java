...
public class VOBeanGenerater {
	...
	public void generateVOBean(String tableName, String packageName1)
		...
		String packageDir = currentDir + fileSep + "src" + fileSep + "java" + fileSep 
				+ packageName;
		...
		for (int i = 0; i < columnName.size(); i++) {
			...
			String columnName1_First_Upcase = columnName1.toUpperCase()
					.substring(0, 1)
					+ columnName1_lowcase.substring(1);
			...
			out
					.println("  private " + s_type + " " + columnName1_lowcase
							+ ";");
...
//			String[] tablename = { /*"cyuser",*/ /*"cycar"* ,"cyfee","cyfeelist"/*"cyroadbook","cyroadbooklist"*/
//					/*"cyvendor","cybrand","cymodel"*/
//					"cyprovince","cycity","cycounty"
//					/*"cyuserpreference"*/
//					/*"cyblog"*/
//			};
			//String[] tablename = {"user","car"};
			String[] tablename = {"account","brand","car",
								  "city","consume","consumeitem",
								  "contact","corporation","county",
								  "customer","model","province",
								  "vendor"};

			for (int i = 0; i < tablename.length; i++) {
				vobg.generateVOBean(tablename[i], "com.carucrm.vo");
			}
			// vobg.generateVOBean("product", "com.pcsales.vo");
			// vobg.generateVOBean("order1", "com.pcsales.vo");
			// vobg.generateVOBean("printconfig", "com.pcsales.vo");
			// vobg.generateVOBean("stock", "com.stock.vo");
			// System.out.println("Generate stock Successful");
			//
			// vobg.generateVOBean("stockchangehistory", "com.stock.vo");
			// System.out.println("Generate stockchangehistory Successful");
			//
			// vobg.generateVOBean("stockfinancehistory", "com.stock.vo");
			// System.out.println("Generate stockfinance Successful");
			//
			// vobg.generateVOBean("stockreportexpect", "com.stock.vo");
			// System.out.println("Generate stockreportexpect Successful");

			// vobg.generateVOBean("stocktrade", "com.stock.vo");
			// System.out.println("Generate stocktrade Successful");

			// vobg.generateVOBean("testType", "com.pcsales.vo");
