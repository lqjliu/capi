...
public class DBAgentOO {
	...
	public List<Object> selectData(String sql, String className ) throws Exception {
	...
	public static void main(String[] agrs) {
		...
		CyuserVO cyUserVO = new CyuserVO();
		cyUserVO.setCreattime(new Date());
		cyUserVO.setLastmodifiedtime(new Date());
		cyUserVO.setUserid(UserIDGenerator.getInstance().getUserID());
		cyUserVO.setUsername("robin");
		cyUserVO.setEmail("robin@163.net");
		cyUserVO.setPassword("pass");

		try {
			dbAgentOO.insert(cyUserVO);
		} catch (Exception ex) {
			ex.printStackTrace();
		}

		CyuserVO cyUserVO1 = new CyuserVO();
		cyUserVO1.setUsername("robin");
		cyUserVO1.setWhereUsername(true);
		cyUserVO1.setPassword("123456");
		cyUserVO1.setLastmodifiedtime(new Date());
		try {
			dbAgentOO.update(cyUserVO1);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
